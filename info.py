...
BOT_TOKEN = environ.get('BOT_TOKEN', "7939502580:AAFQB49x8mIrLZLmlcb_TtL7SvQh7MjfNHg")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002201481738'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002421242684')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://amlfilter:amlfilter@cluster0.ed8uc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AML_movie_request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AML_LinkZz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+7JIJXkWxHSA0ZjQ1') # Support Chat Link Without https:// or @
